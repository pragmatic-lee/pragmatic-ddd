...
- **Breaking**: `io.pragmatic.ddd.visual` package (model visualization: `DomainModelVisualManager`, parsers, `IVisualOutput`, annotations, `DomainModelVisualInfo`) — removed; static structure documentation is now generated by AI; runtime observability will be reintroduced under a dedicated package in a future version
