...
public class MarkdownEntityActionOutputTest {

    @Test
    public void outputTest() {
        MarkdownEntityActionOutput output = new MarkdownEntityActionOutput();

        List<EntityDescriptor> entityDescriptors = this.mockData();
        String output1 = output.output(entityDescriptors.stream().filter(EntityDescriptor::getRoot).findFirst().get());
