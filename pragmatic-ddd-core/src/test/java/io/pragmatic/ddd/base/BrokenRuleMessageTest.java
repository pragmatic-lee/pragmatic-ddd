...
/**
 * 对应设计文档阶段 6.2：BrokenRuleRegistry（抽象基类 + 反射自动注册）单元测试。
 */
public class BrokenRuleMessageTest {
    ...
    public void constructor_reflection_auto_register() {
        SampleBrokenRuleRegistry message = SampleBrokenRuleRegistry.INSTANCE;
    ...
    public void of_factory_inline() {
        BrokenRuleRegistry message = BrokenRuleRegistry.of(
    ...
    public void manual_register_via_subclass() {
        BrokenRuleRegistry message = new BrokenRuleRegistry() {{
