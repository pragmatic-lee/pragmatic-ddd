 ...
 *   <li>{@link #of(boolean)} — 由 boolean 直接构造（无动态参数）</li>
 * </ul>
 *
 * @author wizard-lee
 */
public class RuleCheckResult {
    ...
    /** 由 boolean 直接构造结果：true 视为通过，false 视为失败（无动态参数）。 */
    public static RuleCheckResult of(boolean satisfy) {
        return satisfy ? pass() : fail();
    }
